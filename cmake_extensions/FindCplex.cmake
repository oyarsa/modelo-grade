...
FIND_PATH(CPLEX_CPOPTIMIZER_INCLUDE_DIR
  ilcp/cp.h
...
FIND_LIBRARY(CPLEX_CPOPTIMIZER_LIBRARY
  cp
  HINTS ${CPLEX_ROOT_DIR}/cpoptimizer/lib/${CPLEX_WIN_PLATFORM} #windows
...
message(STATUS "CPOPTIMIZER Library: ${CPLEX_CPOPTIMIZER_LIBRARY}")
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(CPLEX DEFAULT_MSG
 ...
 CPLEX_CONCERT_INCLUDE_DIR CPLEX_CPOPTIMIZER_LIBRARY)

IF(CPLEX_FOUND)
  SET(CPLEX_INCLUDE_DIRS ${CPLEX_INCLUDE_DIR} ${CPLEX_CONCERT_INCLUDE_DIR} ${CPLEX_CPOPTIMIZER_INCLUDE_DIR})
  SET(CPLEX_LIBRARIES ${CPLEX_CPOPTIMIZER_LIBRARY} ${CPLEX_CONCERT_LIBRARY} ${CPLEX_ILOCPLEX_LIBRARY} ${CPLEX_LIBRARY} )
...
MARK_AS_ADVANCED(CPLEX_LIBRARY CPLEX_INCLUDE_DIR CPLEX_ILOCPLEX_LIBRARY CPLEX_CONCERT_INCLUDE_DIR CPLEX_CONCERT_LIBRARY
  CPLEX_CPOPTIMIZER_INCLUDE_DIR CPLEX_CPOPTIMIZER_LIBRARY)
